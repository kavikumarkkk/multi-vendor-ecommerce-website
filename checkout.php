	...
	<div class="container my-5">
		...
		<table id="cart" class="table table-hover table-condensed">
			...
			<?php
				...
				echo '<tr><td colspan="5"><p>Nothing yet in your basket :( <br><small> Order some meal now!</small></p></td></tr>';
			}
					...
					<td colspan="2">
						...
						<div id="paypal" style="display: none;">
							<form action="<?php echo PAYPAL_URL; ?>" method="post">
								...
								<input type="hidden" name="item_name" value="<?php echo 'GOS Services'; ?>">
